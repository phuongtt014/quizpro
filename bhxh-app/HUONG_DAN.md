...
- **Làm tròn:** từng khoản của từng NV được làm tròn đến 1 đồng theo đúng nguyên tắc hàm **ROUND** (làm tròn đến số nguyên gần nhất; phần .5 làm tròn ra xa số 0 — ví dụ 100.000,5 → 100.001, và −100.000,5 → −100.001 khi thoái thu). Tổng bằng cộng các số đã làm tròn.
...
- **Tổng hợp**: thay vì chỉ chọn theo **năm**, nay chọn khoảng thời gian linh hoạt bằng 2 ô **"Từ kỳ"** / **"Đến kỳ"** (chọn tháng/năm), cho phép xem một khoảng bất kỳ (ví dụ nửa năm, năm tài chính không trùng năm dương lịch…). Gồm 3 bảng:
  ...
  2. **Tổng hợp theo phòng ban** (mới) – cộng dồn cả khoảng thời gian đã chọn theo từng phòng ban, cùng thứ tự cột như bảng theo tháng (thay cột Kỳ/Trạng thái/NV đóng bằng cột Phòng ban).
...
2. Vào **Thiết lập → Tỉ lệ Công đoàn**, thêm **hai** tỉ lệ giữ lại riêng: một cho **Đoàn phí công đoàn (NLĐ)**, một cho **Kinh phí công đoàn (DN)**, cùng **Ngày hiệu lực**. Tỉ lệ nộp Công đoàn Việt Nam của mỗi bên tự tính = 100% − tỉ lệ giữ lại tương ứng.
   ...
   - **Thứ tự làm tròn:** phần **nộp Công đoàn Việt Nam** được tính và làm tròn (theo nguyên tắc hàm ROUND) trước; phần **giữ lại cơ sở** = tổng thu − phần nộp đã làm tròn (không làm tròn riêng). Nhờ vậy số nộp lên cấp trên luôn đúng theo công thức, còn chênh lệch làm tròn (nếu có) rơi vào phần giữ lại tại công ty.
...
- **Mở lại kỳ:** ở màn hình **Kỳ BHXH**, Admin bấm nút **"Mở lại kỳ"** trên dòng kỳ đã chốt để chuyển về *Đang mở* — không cần sửa tay trên Sheet nữa. Sau khi mở lại, sửa dữ liệu và bấm **Tính** lại như bình thường; nhớ **Chốt kỳ** lại sau khi xong.
- **Xóa kỳ:** Admin bấm nút **"Xóa kỳ"** để xóa hẳn một kỳ (chỉ xóa được **kỳ mới nhất**, để tránh làm đứt quãng dữ liệu các kỳ sau) — xóa toàn bộ dữ liệu NV của kỳ, kết quả tính, và các dòng Truy thu/Thoái thu ghi nhận trong kỳ đó. **Không thể hoàn tác.** Dùng khi tạo nhầm kỳ hoặc cần làm lại từ đầu cho kỳ mới nhất.
